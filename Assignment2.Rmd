...
### 3. Posivite and Negative Imbalance Price
...
raw_df%>% 
    ggplot(aes(x=NegativeIP, y=PositiveIP, color=Date)) + 
      geom_point() +  
...
This report gives some basic information about monthly energy market, i.e., MCP,SMP, positive imbalance price, negative imbalance price, and SMP direction. More information about the electricty energy market, you can visit wb page of the [EPIAS](https://www.epias.com.tr/).